...
copyright = "2022-%s, %s" % (datetime.now().year, author)
...
latex_documents = [
    (master_doc, "petprep.tex", "PETprep Documentation",
     author,
     "manual"),
]
...
man_pages = [
    (master_doc, "petprep", "petprep Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "petprep", "PETprep Documentation",
     author, "petprep", "One line description of project.",
     "Miscellaneous"),
]
...
linkcode_resolve = make_linkcode_resolve("petprep",
                                         "https://github.com/nipreps/"
                                         "petprep/blob/{revision}/"
